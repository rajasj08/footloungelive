...
$cutimage= "https://footlounge.in.in/image/".$valuen->image;
...
<td style="text-align:right; width:15%"><img src="https://footlounge.in.in/image/data/Social%20Icons/IndianRupee.png" style="height:8px; width:8px;"> '.round($shopprodprice).'</td>
<td style="text-align:right; width:15%"><img src="https://footlounge.in.in/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($shopprodprice).'</td>
</tr>';
         ...
         $shopbag.='<tr style="background:#f0f0c3; "><td colspan="4" align="right">Sub-Total : </td><td style="float:right;"><img src="https://footlounge.in.in/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($totalval).'</td></tr>
<tr style="background:#f0f0c3; "><td colspan="4" align="right">Total : </td><td style="float:right;"><img src="https://footlounge.in.in/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($totalval).'</td></tr></tbody></table>'; 
...
foreach ($productcinfos as $result) {
			...
			$this->data['products'][] = array(
				...
				'price'   	 => $price,
				'special' 	 => $special,
				'href'    	 => 'https://footlounge.in.in/index.php?route=product/product&amp;product_id='.$result['product_id'],
...
$subjectaa ="https://footlounge.in.in/image/".$subjectaa;
...
<p style="text-align:center;"><span><img src="https://footlounge.in.in/image/data/Social%20Icons/IndianRupee.png" style="height:8px;width:8px;"> '.round($pricevali).'</span></p>
...
<a style="color:#FFF !important; text-align:center; cursor:pointer;" href="'.$info['href'].'" class="shopnownbtn"><div style="cursor:pointer;"><button class="mybtnccls" style="height:35px; width:80%; color: #000;border: 2px solid #ccc !important; cursor:pointer;">Shop Now</button></div></a></p>
 ...
 $latestpros.='</tr>
	...
	$changename= ucfirst($domain1);
       ...
       if($abuserid){
	$checkoutnowbtnval='https://footlounge.in.in/cart?abuserid='.$abuserid; } 
else{$checkoutnowbtnval='https://footlounge.in.in/';}
//echo 'http://'. $_SERVER['SERVER_NAME']."<br/>" . $_SERVER['REQUEST_URI']; 
/*
$url = "https://footlounge.in.in/discountmsg.html";
$ch = curl_init();
...
*/
        $message1= htmlentities(file_get_contents("https://footlounge.in.in/discountmsg.html"));   
...
{
$discountdisn='<img src="https://footlounge.in.in/image/data/Social%20Icons/IndianRupee.png" style="height:10px;width:10px;">'.$discountdisn;
              $strn2=str_replace('ndispercent',$discountdisn,$message1);  
}
