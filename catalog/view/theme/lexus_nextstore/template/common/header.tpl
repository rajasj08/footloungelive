...
window.location.href ="https://footlounge.in.in/index.php?route=product/search&search=" + sval + "&category_id=" +searches;
}
...
<script type="application/ld+json">
{
 "@context": "http://schema.org/",
  "@type": "WebSite",
  "url": "https://footlounge.in.in/",
  "potentialAction": {
    "@type": "SearchAction",
     "target":"https://footlounge.in.in/search?term={search_term_string}",
					...
					<div class="show-desktop ">
						<div class="quick-access pull-left">
							<ul class="links">								
								...
								<li><a href="https://footlounge.in.in/Footlounge-Frequently-Asked-Questions" id="help" data-toggle="tooltip" title="FAQ" data-placement="bottom"><i class="fa fa-info-circle"></i><?php echo $text_help; ?></a></li>

								<!--<li><a href="<?php echo $account; ?>"><i class="fa fa-user"></i><?php echo $text_account; ?></a></li>-->

								<li><a href="https://footlounge.in.in/voucher" data-toggle="tooltip" title="Gift Cards" data-placement="bottom"><i class="fa fa-gift"></i><?php echo $text_giftcards; ?></a></li> 
...
<div class="logo1 inner1">  
					...
					<div class="toppart">
						...
						<div class="toppartright">
							...
							<div class="socialicons">
								...
								<div class="social-icon1"><a target="_blank" href="   https://in.pinterest.com/footloungeindia/"><img src="https://footlounge.in.in/image/social-icons/pinterest_27.png"></a></div>

								<div class="social-icon1"><a target="_blank" href=" https://plus.google.com/115256944391879546136/posts"><img src="https://footlounge.in.in/image/social-icons/google_plus27.png"></a></div>

								<div class="social-icon1"><a target="_blank" href="https://www.youtube.com/c/adidas"><img src="https://footlounge.in.in/image/social-icons/youtube-iconsmall.png" alt="Foot Lounge YouTube"></a></div>  
								
								<div class="social-icon1"><a target="_blank" href="https://www.instagram.com/go_footlounge"><img src="https://footlounge.in.in/image/social-icons/instagramsmall.png" alt="Foot Lounge Instagram"></a></div>
								 
								<div class="social-icon1"><a target="_blank" href="https://twitter.com/go_footlounge"><img src="https://footlounge.in.in/image/social-icons/twittersmall1.png" alt="Foot LoungeTwitter"></a></div>	
					...
					<div class="bottompart">
						...
						<div class="cart-mini-right">
							<!--<div class="socialicons">
								<div class="social-icon1"><img src="https://footlounge.in.in/image/social-icons/twitter.png" style=" height:40px; width:40px;" alt="Foot LoungeTwitter"></div>
								<div class="social-icon1"><img src="https://footlounge.in.in/image/social-icons/instagramsmall.png" style=" height:40px; width:40px;" alt="Foot Lounge Instagram"></div>
								<div class="social-icon1"><img src="https://footlounge.in.in/image/social-icons/you-tube-icon.png" style=" height:40px; width:40px;" alt="Foot Lounge YouTube"></div>
