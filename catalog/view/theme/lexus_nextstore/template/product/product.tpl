				...
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 product-view">				
					...
					<div class="price" style="padding:0px!important">
						<div class="price-gruop">
							...
							&nbsp;<span class="price-new specialpricenew"><span class="showsploffmsg" data-toggle="popover" data-trigger="hover" data-content="<p class='proddisccontent'>(Special Price because you bought <span class='proddisccontent1'><a class='proddisccontent1' href='https://footlounge.in.in/index.php?route=product/product&product_id=<?php echo trim($mainproductidinfo); ?>'><?php echo $mainproductname; ?></a></span>)</p>"><i class='fa fa-check' aria-hidden='true'></i></span>You Pay:&nbsp;<?php echo $special; ?> <!--<span class="income"><?php echo $saving; ?>% <?php echo $text_income; ?></span> --></span> 
...
<div id="kdesc" style="font-size:19px;color:yellowgreen ;font-weight:bold;display:none"></div>
						...
						<?php if($discountofferprod){
								?>		
		 			<!--<p class="proddisccontent">Special price by adding this product <span class="proddisccontent1"><a class="proddisccontent1" href="https://footlounge.in.in/index.php?route=product/product&product_id=<?php echo trim($mainproductidinfo); ?>"><?php echo $mainproductname; ?></a></span></p> -->
...
<?php
 ...
 ?>
			...
			<a class="sharesocial">SHARE: &nbsp;</a> 
				...
				<a onclick="PopupCenter('https://plus.google.com/share?url=https://footlounge.in.in','xtf','450','400');"><img class="piconcls" src="https://footlounge.in.in/image/social-icons/google_plus27.png"></a>&nbsp;&nbsp;<a onclick="PopupCenter('https://twitter.com/intent/tweet?text=@go_footlounge&','xtf','450','400');"><img class="piconcls" src="https://footlounge.in.in/image/social-icons/twittersmall1.png"></a>&nbsp; 
				<a onclick="PopupCenter('http://www.facebook.com/sharer/sharer.php?u=https://footlounge.in.in','xtf','450','400');"> <img class="piconcls" src="https://footlounge.in.in/image/icon-facebook.png"></a>
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!--<div style="margin-bottom: 20px;" ><p>This product has been solded out! Kindly fill the following details, our executive will contact you in another 48 hours. <a href="https://footlounge.in.in/new-arrivals"><span style="color: #CD6927 " id="modal_content">Happy Shopping</span><a></p></div>-->
      ...
      <span class="alert alert-danger new_asearch_padd1" id="failure_msg">sending failed</span>
      	<img src="https://footlounge.in.in/image/loading_spinner.gif" alt="loading..." id="image_spinner">
